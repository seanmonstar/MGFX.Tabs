...
web build:
 - http://mootools.net/core/c07e68be71d8a8406abe49c8c6f88665

packager build:
 - packager build Core/Event Core/Element.Event Core/Fx.CSS
...
}return false;};})();(function(){var c=document.html;Element.Properties.styles={set:function(f){this.setStyles(f);}};var e=(c.style.opacity!=null);var d=/alpha\(opacity=([\d.]+)\)/i;
